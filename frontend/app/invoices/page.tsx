...
const vendors = ["Alpine", "Ascon", "MG development","CoolSafety", "Audinell", "Bernafon", "Duraxx", "Ewanto", "GN", "Oticon", "Phonak", "Sivantos", "Sivantos A/S", "Starkey", "Widex", 'unitron', 'Private Uafhængige']
